...
// DataBlock is the message format sent from client to server.
type DataBlock struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`       // e.g., "user.update", "data.stream"
	Payload       []byte                 `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"` // The actual data payload
...
func (x *DataBlock) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
